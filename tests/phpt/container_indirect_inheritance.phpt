--TEST--
Indirect Container modifications (inheritance)
--SKIPIF--
<?php include('skipif.inc'); ?>
--FILE--
<?php
/*
 * Child class does not override offsetGet()
 * Overloading should work the same way as
 * if it were TurboSlim\Container
 */
...
Notice: Indirect modification of overloaded element of MyContainer has no effect in %s on line %d
OK
int(8)
int(2)
array(1) {
