...
class RequestBodyTest extends \PHPUnit\Framework\TestCase
{
    ...
    /*
     * Constructor does NOT set metadata.
     * setUp() calls write(), which, in turn, calls isWritable(), which invokes getMetadata()
     * TurboSlim avoids this unnecessary call to getMetadata() because it can fetch this information
    ...
    public function testConstructorSetsMetadata()
    {
        ...
        $this->assertInternalType('null', $bodyMetadata->getValue($this->body));
    }
