...
TURBOSLIM_VISIBILITY_HIDDEN zval* turboslim_no_props_read_property(zval* object, zval* member, int type, void** cache_slot, zval* rv);
TURBOSLIM_VISIBILITY_HIDDEN void turboslim_no_props_write_property(zval* object, zval* member, zval* value, void** cache_slot);
TURBOSLIM_VISIBILITY_HIDDEN int turboslim_no_props_has_property(zval* object, zval* member, int has_set_exists, void** cache_slot);
TURBOSLIM_VISIBILITY_HIDDEN void turboslim_no_props_unset_property(zval* object, zval* member, void** cache_slot);
